...
def list_records_by_date(start_date, end_date):
    ...
    try:
        ...
        print('날짜 형식이 올바르지 않습니다. 예: 20240101')
        return
...
def run():
    ...
    while True:
        ...
        if choice == '1':
            ...
            start_date = input('시작 날짜 입력 (예: 20240101): ').strip()
            end_date = input('종료 날짜 입력 (예: 20240131): ').strip()
